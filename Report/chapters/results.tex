...
past. Overall, both orchestrators indicated low confidence in explaining
...
The scratcher evaluated Scratch's ability to achieve modularity, instantiation
and event handling as high, and state management as low. In
addition, the scratcher indicated increased confidence in explaining any of
...
the scratcher reported. One orchestrator reported low confidence in explaining
any of the concepts. The other student answers with high confidence in explaining event
handling. State management was rated neutral from both orchestrators. In
...
survey, which aligns with the low test results. The scratcher reported high
...
survey showed an increase in confidence. The scratcher indicated a better
understanding of those two concepts, and scored on related questions. One of the
orchestrators did not feel improvement, which was accordingly reflected
in their test results (i.e., they scored 0\%). The other student reported a smaller
improvement than the scratcher, however they only answered state management-
...
The scratcher answered answered one of the two related questions correctly,
whereas both Godot orchestrators students struggled with both questions. Those results
...
orchestrators, as they progressed slower in their projects than the
scratcher.
...
Instantiation was eventually used on the teacher's proposal. These observations somewhat
conform with the previous surveys and multiple choice test, as the scratcher
...
correctly in the multiple choice test by any orchestrator, which is an
...
where students worked on their projects, again only the scratcher managed to attempt
